...
export class StreamersService {
     ...
     */
    public fetchCollection38(observe?: 'body', reportProgress?: boolean): Observable<InlineResponse200>;
    public fetchCollection38(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse200>>;
    public fetchCollection38(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse200>>;
    public fetchCollection38(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<InlineResponse200>('get',`${this.basePath}/streamers`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public fetchCollection40(observe?: 'body', reportProgress?: boolean): Observable<InlineResponse200>;
    public fetchCollection40(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse200>>;
    public fetchCollection40(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse200>>;
    public fetchCollection40(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<InlineResponse200>('get',`${this.basePath}/streaming-links`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public fetchResource39(id: number, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse20015>;
    public fetchResource39(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse20015>>;
    public fetchResource39(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse20015>>;
    public fetchResource39(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling fetchResource39.');
        }
        ...
        return this.httpClient.request<InlineResponse20015>('get',`${this.basePath}/streamers/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public fetchResource41(id: number, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse20016>;
    public fetchResource41(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse20016>>;
    public fetchResource41(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse20016>>;
    public fetchResource41(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling fetchResource41.');
        }
        ...
        return this.httpClient.request<InlineResponse20016>('get',`${this.basePath}/streaming-links/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
