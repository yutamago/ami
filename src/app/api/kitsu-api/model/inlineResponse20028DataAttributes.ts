...
export interface InlineResponse20028DataAttributes { 
    /**
     ...
     */
    updatedAt?: string;
    status?: InlineResponse20028DataAttributes.StatusEnum;
    /**
    ...
    notes?: string;
    _private?: boolean;
    reactionSkipped?: InlineResponse20028DataAttributes.ReactionSkippedEnum;
    /**
...
export namespace InlineResponse20028DataAttributes {
    export type StatusEnum = 'completed' | 'current' | 'dropped' | 'on_hold' | 'planned';
    ...
    export type ReactionSkippedEnum = 'unskipped' | 'skipped' | 'ignored';
    export const ReactionSkippedEnum = {
        Unskipped: 'unskipped' as ReactionSkippedEnum,
        Skipped: 'skipped' as ReactionSkippedEnum,
        Ignored: 'ignored' as ReactionSkippedEnum
    };
}