...
export interface InlineResponse2001DataAttributes { 
    ...
    ratingRank?: number;
    ageRating?: InlineResponse2001DataAttributes.AgeRatingEnum;
    ageRatingGuide?: string;
    subtype?: InlineResponse2001DataAttributes.SubtypeEnum;
    status?: InlineResponse2001DataAttributes.StatusEnum;
    tba?: string;
     ...
     */
    showType?: InlineResponse2001DataAttributes.ShowTypeEnum;
    /**
     * NSFW media requires authentication
     */
    nsfw?: boolean;
}
export namespace InlineResponse2001DataAttributes {
    ...
    export type SubtypeEnum = 'ONA' | 'OVA' | 'TV' | 'movie' | 'music' | 'special';
    export const SubtypeEnum = {
        ONA: 'ONA' as SubtypeEnum,
        OVA: 'OVA' as SubtypeEnum,
        TV: 'TV' as SubtypeEnum,
        Movie: 'movie' as SubtypeEnum,
        Music: 'music' as SubtypeEnum,
        Special: 'special' as SubtypeEnum
    };
    ...
    export type ShowTypeEnum = 'ONA' | 'OVA' | 'TV' | 'movie' | 'music' | 'special';
    export const ShowTypeEnum = {
        ONA: 'ONA' as ShowTypeEnum,
        OVA: 'OVA' as ShowTypeEnum,
        TV: 'TV' as ShowTypeEnum,
        Movie: 'movie' as ShowTypeEnum,
        Music: 'music' as ShowTypeEnum,
        Special: 'special' as ShowTypeEnum
    };
}