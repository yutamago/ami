/**
 * Ausführen um nach Angular-CLI Zeug weiterzuentwickeln.
 */
...
for (const project of Object.keys(angularJson.projects)) {
  ...
  for (const config of Object.keys(projectConfig.architect)) {
    ...
    if (configObj.builder === '@angular-devkit/build-angular:dev-server') {
      configObj.builder = '@angular-builders/custom-webpack:dev-server';
    }

    // Ersetze "@angular-builders/custom-webpack:browser" durch "@angular-devkit/build-angular:browser"
    if (configObj.builder === '@angular-devkit/build-angular:browser') {
      configObj.builder = '@angular-builders/custom-webpack:browser';
    }
  }
}
