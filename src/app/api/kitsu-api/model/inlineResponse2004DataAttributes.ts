 ...
 */
import { DramaAttributesTitles } from './dramaAttributesTitles';
import { InlineResponse2001DataAttributesCoverImage } from './inlineResponse2001DataAttributesCoverImage';
import { InlineResponse2001DataAttributesPosterImage } from './inlineResponse2001DataAttributesPosterImage';
import { InlineResponse2001DataAttributesRatingFrequencies } from './inlineResponse2001DataAttributesRatingFrequencies';
...
export interface InlineResponse2004DataAttributes { 
    ...
    titles?: DramaAttributesTitles;
    canonicalTitle?: string;
    abbreviatedTitles?: any;
    averageRating?: string;
    ratingFrequencies?: InlineResponse2001DataAttributesRatingFrequencies;
    userCount?: number;
    ...
    ratingRank?: number;
    ageRating?: InlineResponse2004DataAttributes.AgeRatingEnum;
    ageRatingGuide?: string;
    subtype?: InlineResponse2004DataAttributes.SubtypeEnum;
    status?: InlineResponse2004DataAttributes.StatusEnum;
    tba?: string;
    posterImage?: InlineResponse2001DataAttributesPosterImage;
    coverImage?: InlineResponse2001DataAttributesCoverImage;
    chapterCount?: number;
    volumeCount?: number;
     ...
     */
    mangaType?: InlineResponse2004DataAttributes.MangaTypeEnum;
}
export namespace InlineResponse2004DataAttributes {
    export type AgeRatingEnum = 'G' | 'PG' | 'R' | 'R18' | 'null';
    export const AgeRatingEnum = {
        G: 'G' as AgeRatingEnum,
        PG: 'PG' as AgeRatingEnum,
        R: 'R' as AgeRatingEnum,
        R18: 'R18' as AgeRatingEnum,
        Null: 'null' as AgeRatingEnum
    };
    export type SubtypeEnum = 'doujin' | 'manga' | 'manhua' | 'manhwa' | 'novel' | 'oel' | 'oneshot';
    export const SubtypeEnum = {
        Doujin: 'doujin' as SubtypeEnum,
        Manga: 'manga' as SubtypeEnum,
        Manhua: 'manhua' as SubtypeEnum,
        Manhwa: 'manhwa' as SubtypeEnum,
        Novel: 'novel' as SubtypeEnum,
        Oel: 'oel' as SubtypeEnum,
        Oneshot: 'oneshot' as SubtypeEnum
    };
    export type StatusEnum = 'current' | 'finished' | 'tba' | 'unreleased' | 'upcoming';
    export const StatusEnum = {
        Current: 'current' as StatusEnum,
        Finished: 'finished' as StatusEnum,
        Tba: 'tba' as StatusEnum,
        Unreleased: 'unreleased' as StatusEnum,
        Upcoming: 'upcoming' as StatusEnum
    };
    export type MangaTypeEnum = 'doujin' | 'manga' | 'manhua' | 'manhwa' | 'novel' | 'oel' | 'oneshot';
    export const MangaTypeEnum = {
        Doujin: 'doujin' as MangaTypeEnum,
        Manga: 'manga' as MangaTypeEnum,
        Manhua: 'manhua' as MangaTypeEnum,
        Manhwa: 'manhwa' as MangaTypeEnum,
        Novel: 'novel' as MangaTypeEnum,
        Oel: 'oel' as MangaTypeEnum,
        Oneshot: 'oneshot' as MangaTypeEnum
    };
}