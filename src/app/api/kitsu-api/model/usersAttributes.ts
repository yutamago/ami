 ...
 */
import { UsersAttributesAvatar } from './usersAttributesAvatar';
import { UsersAttributesCoverImage } from './usersAttributesCoverImage';
...
export interface UsersAttributes { 
    ...
    website?: string;
    proTier?: string;
    avatar?: UsersAttributesAvatar;
    coverImage?: UsersAttributesCoverImage;
    /**
     * Logged in user only
     */
    email?: string;
     ...
     * Logged in user only
     */
    titleLanguagePreferenceCanonical?: UsersAttributes.TitleLanguagePreferenceCanonicalEnum;
    /**
     ...
     * Logged in user only
     */
    ratingSystem?: UsersAttributes.RatingSystemEnum;
    /**
     * Logged in user only
     */
    theme?: UsersAttributes.ThemeEnum;
    /**
     * Logged in user only
     */
    facebookId?: string;
...
export namespace UsersAttributes {
