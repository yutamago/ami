...
export interface LibraryEntriesAttributes { 
    /**
     ...
     */
    updatedAt?: string;
    status?: LibraryEntriesAttributes.StatusEnum;
    /**
    ...
    notes?: string;
    _private?: boolean;
    reactionSkipped?: LibraryEntriesAttributes.ReactionSkippedEnum;
    /**
...
export namespace LibraryEntriesAttributes {
