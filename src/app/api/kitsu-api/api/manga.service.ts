...
export class MangaService {
     ...
     */
    public fetchCollection10(observe?: 'body', reportProgress?: boolean): Observable<InlineResponse2003>;
    public fetchCollection10(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse2003>>;
    public fetchCollection10(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse2003>>;
    public fetchCollection10(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<InlineResponse2003>('get',`${this.basePath}/trending/manga`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public fetchCollection6(observe?: 'body', reportProgress?: boolean): Observable<InlineResponse200>;
    public fetchCollection6(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse200>>;
    public fetchCollection6(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse200>>;
    public fetchCollection6(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<InlineResponse200>('get',`${this.basePath}/manga`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public fetchCollection8(observe?: 'body', reportProgress?: boolean): Observable<InlineResponse200>;
    public fetchCollection8(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse200>>;
    public fetchCollection8(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse200>>;
    public fetchCollection8(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<InlineResponse200>('get',`${this.basePath}/chapters`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public fetchResource7(id: number, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse2004>;
    public fetchResource7(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse2004>>;
    public fetchResource7(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse2004>>;
    public fetchResource7(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling fetchResource7.');
        }
        ...
        return this.httpClient.request<InlineResponse2004>('get',`${this.basePath}/manga/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public fetchResource9(id: number, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse2005>;
    public fetchResource9(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse2005>>;
    public fetchResource9(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse2005>>;
    public fetchResource9(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling fetchResource9.');
        }
        ...
        return this.httpClient.request<InlineResponse2005>('get',`${this.basePath}/chapters/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
