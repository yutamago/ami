...
@Injectable()
export class SiteAnnouncementsService {
     ...
     */
    public fetchCollection251(observe?: 'body', reportProgress?: boolean): Observable<InlineResponse200>;
    public fetchCollection251(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse200>>;
    public fetchCollection251(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse200>>;
    public fetchCollection251(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<InlineResponse200>('get',`${this.basePath}/site-announcements`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public fetchResource252(id: number, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse20063>;
    public fetchResource252(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse20063>>;
    public fetchResource252(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse20063>>;
    public fetchResource252(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling fetchResource252.');
        }
        ...
        return this.httpClient.request<InlineResponse20063>('get',`${this.basePath}/site-announcements/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
