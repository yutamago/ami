...
export class CommentsService {
     ...
     */
    public createResource136(observe?: 'body', reportProgress?: boolean): Observable<any>;
    public createResource136(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public createResource136(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public createResource136(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createResource141(observe?: 'body', reportProgress?: boolean): Observable<any>;
    public createResource141(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public createResource141(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public createResource141(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('post',`${this.basePath}/comment-likes`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public deleteResource139(id: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public deleteResource139(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public deleteResource139(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public deleteResource139(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling deleteResource139.');
        }
        ...
        return this.httpClient.request<any>('delete',`${this.basePath}/comments/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public deleteResource143(id: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public deleteResource143(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public deleteResource143(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public deleteResource143(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling deleteResource143.');
        }
        ...
        return this.httpClient.request<any>('delete',`${this.basePath}/comment-likes/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public fetchCollection135(observe?: 'body', reportProgress?: boolean): Observable<InlineResponse200>;
    public fetchCollection135(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse200>>;
    public fetchCollection135(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse200>>;
    public fetchCollection135(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<InlineResponse200>('get',`${this.basePath}/comments`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public fetchCollection140(observe?: 'body', reportProgress?: boolean): Observable<InlineResponse200>;
    public fetchCollection140(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse200>>;
    public fetchCollection140(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse200>>;
    public fetchCollection140(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<InlineResponse200>('get',`${this.basePath}/comment-likes`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public fetchResource137(id: number, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse20038>;
    public fetchResource137(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse20038>>;
    public fetchResource137(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse20038>>;
    public fetchResource137(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling fetchResource137.');
        }
        ...
        return this.httpClient.request<InlineResponse20038>('get',`${this.basePath}/comments/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public fetchResource142(id: number, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse20039>;
    public fetchResource142(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse20039>>;
    public fetchResource142(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse20039>>;
    public fetchResource142(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling fetchResource142.');
        }
        ...
        return this.httpClient.request<InlineResponse20039>('get',`${this.basePath}/comment-likes/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateResource138(id: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public updateResource138(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public updateResource138(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public updateResource138(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling updateResource138.');
        }
        ...
        return this.httpClient.request<any>('patch',`${this.basePath}/comments/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
