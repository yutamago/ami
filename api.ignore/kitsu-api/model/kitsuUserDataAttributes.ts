 ...
 */
import { KitsuDataAttributesAvatar } from './kitsuDataAttributesAvatar';
import { KitsuDataAttributesCoverImage } from './kitsuDataAttributesCoverImage';

export interface KitsuUserDataAttributes {
    /**
    ...
    website?: string;
    proTier?: string;
    avatar?: KitsuDataAttributesAvatar;
    coverImage?: KitsuDataAttributesCoverImage;
    /**
     * Logged in user only
     */
    email?: string;
     ...
     * Logged in user only
     */
    titleLanguagePreferenceCanonical?: KitsuDataAttributes.TitleLanguagePreferenceCanonicalEnum;
    /**
     ...
     * Logged in user only
     */
    ratingSystem?: KitsuDataAttributes.RatingSystemEnum;
    /**
     * Logged in user only
     */
    theme?: KitsuDataAttributes.ThemeEnum;
    /**
     * Logged in user only
     */
    facebookId?: string;
...
export namespace KitsuDataAttributes {
    export type TitleLanguagePreferenceCanonicalEnum = 'canonical' | 'romanized' | 'english';
    export const TitleLanguagePreferenceCanonicalEnum = {
        Canonical: 'canonical' as TitleLanguagePreferenceCanonicalEnum,
        Romanized: 'romanized' as TitleLanguagePreferenceCanonicalEnum,
        English: 'english' as TitleLanguagePreferenceCanonicalEnum
    };
    export type RatingSystemEnum = 'advanced' | 'regular' | 'simple';
    export const RatingSystemEnum = {
        Advanced: 'advanced' as RatingSystemEnum,
        Regular: 'regular' as RatingSystemEnum,
        Simple: 'simple' as RatingSystemEnum
    };
