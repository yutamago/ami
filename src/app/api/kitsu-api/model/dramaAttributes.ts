 ...
 */
import { DramaAttributesCoverImage } from './dramaAttributesCoverImage';
import { DramaAttributesPosterImage } from './dramaAttributesPosterImage';
import { DramaAttributesRatingFrequencies } from './dramaAttributesRatingFrequencies';
import { DramaAttributesTitles } from './dramaAttributesTitles';

export interface DramaAttributes { 
    /**
    ...
    ratingFrequencies?: DramaAttributesRatingFrequencies;
    userCount?: number;
    ...
    ratingRank?: number;
    ageRating?: DramaAttributes.AgeRatingEnum;
    ageRatingGuide?: string;
    subtype?: DramaAttributes.SubtypeEnum;
    status?: DramaAttributes.StatusEnum;
    tba?: string;
    posterImage?: DramaAttributesPosterImage;
    coverImage?: DramaAttributesCoverImage;
    episodeCount?: number;
    /**
...
export namespace DramaAttributes {
    ...
    export type SubtypeEnum = 'ONA' | 'TV' | 'movie' | 'music' | 'special';
