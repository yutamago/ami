...
export class AnimeService {
     ...
     */
    public fetchCollection1(observe?: 'body', reportProgress?: boolean): Observable<InlineResponse200>;
    public fetchCollection1(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse200>>;
    public fetchCollection1(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse200>>;
    public fetchCollection1(observe: any = 'body', reportProgress = false ): Observable<any> {
        ...
        return this.httpClient.request<InlineResponse200>('get',`${this.basePath}/anime`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public fetchCollection3(observe?: 'body', reportProgress?: boolean): Observable<InlineResponse200>;
    public fetchCollection3(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse200>>;
    public fetchCollection3(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse200>>;
    public fetchCollection3(observe: any = 'body', reportProgress = false ): Observable<any> {
        ...
        return this.httpClient.request<InlineResponse200>('get',`${this.basePath}/episodes`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public fetchCollection5(observe?: 'body', reportProgress?: boolean): Observable<InlineResponse2003>;
    public fetchCollection5(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse2003>>;
    public fetchCollection5(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse2003>>;
    public fetchCollection5(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<InlineResponse2003>('get',`${this.basePath}/trending/anime`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public fetchResource2(id: number, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse2001>;
    public fetchResource2(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse2001>>;
    public fetchResource2(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse2001>>;
    public fetchResource2(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling fetchResource2.');
        }
        ...
        return this.httpClient.request<InlineResponse2001>('get',`${this.basePath}/anime/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public fetchResource4(id: number, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse2002>;
    public fetchResource4(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse2002>>;
    public fetchResource4(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse2002>>;
    public fetchResource4(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling fetchResource4.');
        }
        ...
        return this.httpClient.request<InlineResponse2002>('get',`${this.basePath}/episodes/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
